        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Delete Retailer</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" class="needs-validation" novalidate method="post" id="deleteRetailerFormContainer">
                            ...
                            <div class="wizard-tab">
                                <div class="text-center mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 offset-md-3">
                                            <div class="mt-3">
                                                <input type="text" class="form-control" id="deleteSearchRetailer" name="search" placeholder="Enter Retailer ID, or Shop name, or Customer name" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="showRetailerDeleteInfo" class="d-none">
                                    <div class="row">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body pt-xl-1">
                                                        <div class="table-responsive">
                                                            <table id="searchRetailerDeleteTable" class="table table-striped table-centered align-middle table-nowrap mb-0">
                                                                <thead>
                                                                    <tr>
                                                                        <th>&nbsp;</th>
                                                                        <th>ID</th>
